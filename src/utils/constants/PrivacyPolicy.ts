export const PrivacyPolicyAccordion = [
  {
    id: "1",
    accordionTitle: "What Information We Collect",
    accordionContent: `<div>
                  <strong>Anonymous Browsing:</strong>
                </div>
                <div>
                  Users browsing non-password protected sections of the site do
                  so anonymously, and no personally identifiable information is
                ...
                <div>
                  The document defines personal data as information that can be
                  unequivocally linked to a specific individual, disclosing
                ...
                <div>
                  When applying for or maintaining a Corsa Futures Demo or Live
                  account, the company collects personal information for various
                  business purposes, such as evaluating financial needs,
                  processing requests and transactions, informing about relevant
                  products and services, and providing client service.
                </div>
                ...
                <ul>
                  ...
                  <li>
                    Transaction Information: Account balances, trading activity,
                    inquiries, responses.
                  </li>
                  <li>
                ...
                <div>
                  Users can deactivate their accounts at any time, resulting in
                  the deletion of personally identifiable information from
                ...
                <div>
                  Non-personally identifiable information is also collected when
                  users engage in certain activities such as posting comments,
                  providing feedback, or answering surveys. This type of
                  information is considered non-confidential and may be
                  disclosed and used by Corsa Futures without requiring user
                  permission.
                </div>

                <div>
                  It’s important for users to be aware of the information being
                  collected, how it’s used, and the company’s commitment to
  ...
  {
    id: "2",
    accordionTitle: "How We Use the Information We Collect",
    accordionContent: `<div>
                    <strong>Anonymous Browsing:</strong>
                  </div>
                  <div>
  ...
  {
    id: "3",
    accordionTitle: "Technical Information & Data Security",
    accordionContent: `
                  <div>
  ...
  {
    id: "4",
    accordionTitle: "Social Networks",
    accordionContent: `
                  <div>
  ...
  {
    id: "5",
    accordionTitle: "Disclosure of information to third parties",
    accordionContent: `
                  <p>
  ...
  {
    id: "7",
    accordionTitle: "Third Party links and Advertisements",
    accordionContent: `
                   <p>
  ...
  {
    id: "8",
    accordionTitle: "Protecting your information",
    accordionContent: `
                   <p>
  ...
  {
    id: "10",
    accordionTitle: "Changes to legal requirements",
    accordionContent: `
                   <p>
                    We have implemented a diverse range of security protocols,
                    including SSL encryption technology, firewalls, and
