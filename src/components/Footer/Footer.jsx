                ...
                <div>
                    ...
                    <div className="footer-content-container">
                        ...
                        <div className="footer-content-right">
                            ...
                            <input type="text" className="text-field" placeholder="Name"></input>
                            <input type="text" className="text-field" placeholder="Enter your email"></input>
                    ...
                    <div>
                      <p>Risk Warning : </p>
                      <p>Trading involves risk. Please be aware of the risks involved and seek independent advice if necessary.</p>

                      <div className="footer-placeholder"></div>

                      <p>Terms of Service: </p>
                      <p>Review our terms of service to understand the guidelines and conditions for using our platform.</p>
